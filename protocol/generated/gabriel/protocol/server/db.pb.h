...
inline void DB_Msg::set_outerenum(gabriel::protocol::server::OuterEnum value) {
  GOOGLE_DCHECK(gabriel::protocol::server::OuterEnum_IsValid(value));
  set_has_outerenum();
  outerenum_ = value;
}
...
inline void DB_Msg::set_innerenum(::gabriel::protocol::server::Outer_InnerEnum value) {
  GOOGLE_DCHECK(::gabriel::protocol::server::Outer_InnerEnum_IsValid(value));
  set_has_innerenum();
  innerenum_ = value;
}
...
inline void DB_Msg::set_pubenum(gabriel::protocol::PubEnum value) {
  GOOGLE_DCHECK(gabriel::protocol::PubEnum_IsValid(value));
  set_has_pubenum();
  pubenum_ = value;
}
...
inline void DB_Msg::set_pubinnerenum(::gabriel::protocol::PubOuter_PubInnerEnum value) {
  GOOGLE_DCHECK(::gabriel::protocol::PubOuter_PubInnerEnum_IsValid(value));
