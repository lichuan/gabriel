...
class Server_Info : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_inner_addr(::std::string* inner_addr);
  ...
  inline void set_allocated_outer_addr(::std::string* outer_addr);
...
class Center_Addr_Rsp : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_info(::gabriel::protocol::server::Server_Info* info);
...
inline void Server_Info::set_allocated_inner_addr(::std::string* inner_addr) {
  if (inner_addr_ != &::google::protobuf::internal::kEmptyString) {
    delete inner_addr_;
  }
  if (inner_addr) {
    set_has_inner_addr();
    inner_addr_ = inner_addr;
  } else {
    clear_has_inner_addr();
    inner_addr_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  }
...
inline void Server_Info::set_allocated_outer_addr(::std::string* outer_addr) {
  if (outer_addr_ != &::google::protobuf::internal::kEmptyString) {
    delete outer_addr_;
  }
  if (outer_addr) {
    set_has_outer_addr();
    outer_addr_ = outer_addr;
  } else {
    clear_has_outer_addr();
    outer_addr_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  }
...
inline void Center_Addr_Rsp::set_allocated_info(::gabriel::protocol::server::Server_Info* info) {
  delete info_;
  info_ = info;
  if (info) {
    set_has_info();
